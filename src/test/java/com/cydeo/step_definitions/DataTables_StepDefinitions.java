...
public class DataTables_StepDefinitions {
    @Then("User should see blow list")
    public void user_should_see_blow_list(List<String> fruitsAndVegtables) {

        System.out.println("fruitsAndVegtables = " + fruitsAndVegtables);
    }
